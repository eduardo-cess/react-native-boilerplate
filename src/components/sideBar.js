...
class SideBar extends Component {
    ...
    render() {
        ...
        <Image source={{uri: 'https://static.wixstatic.com/media/647c38_179df1cfc5ee4e89ae5443c32a83343f~mv2.png/v1/fill/w_630,h_388,al_c,usm_0.66_1.00_0.01/647c38_179df1cfc5ee4e89ae5443c32a83343f~mv2.png'}} style={{height: 200, width: null, flex: 1}}/>
            <List>
            <ListItem icon>
                <Left>
                <Icon name="wifi" />
